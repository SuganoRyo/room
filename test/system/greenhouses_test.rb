...
class GreenhousesTest < ApplicationSystemTestCase
  ...
  test "creating a Greenhouse" do
    ...
    fill_in "Address", with: @greenhouse.address
    fill_in "Image", with: @greenhouse.image
    fill_in "Introduction", with: @greenhouse.introduction
    fill_in "Name", with: @greenhouse.name
    fill_in "Price", with: @greenhouse.price
