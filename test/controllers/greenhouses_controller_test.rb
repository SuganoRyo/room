...
class GreenhousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create greenhouse" do
    assert_difference('Greenhouse.count') do
      post greenhouses_url, params: { greenhouse: { address: @greenhouse.address, image: @greenhouse.image, introduction: @greenhouse.introduction, name: @greenhouse.name, price: @greenhouse.price } }
    end
  ...
  test "should update greenhouse" do
    patch greenhouse_url(@greenhouse), params: { greenhouse: { address: @greenhouse.address, image: @greenhouse.image, introduction: @greenhouse.introduction, name: @greenhouse.name, price: @greenhouse.price } }
