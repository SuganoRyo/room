...
ActiveRecord::Schema.define(version: 2021_07_16_053029) do
  ...
  create_table "reservers", force: :cascade do |t|
    ...
    t.index ["greenhouse_id"], name: "index_reservers_on_greenhouse_id"
  end
  ...
  add_foreign_key "reservers", "greenhouses"
end
